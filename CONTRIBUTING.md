...
```bash
$ git clone git@github.com:username/dcharting.git
```

This will clone your fork to your current path in a directory named `dcharting`.
...
```bash
$ cd dcharting
$ git remote add upstream git@github.com:ibm-dojo/dcharting.git
$ git fetch upstream
```
